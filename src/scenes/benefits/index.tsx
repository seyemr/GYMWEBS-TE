    ...
    return(
        ...
        <motion.div
          ...
          className="md:my-5 md:w-3/5">
            <HText>Sadece bir spor salonundan daha fazlası</HText>
            <p className="my-5 text-sm">
            Sizi kolaylıkla nihai fitness hedeflerinize götürmek için dünya standartlarında fitness ekipmanları, eğitmenler ve dersler sunuyoruz. Her üyeye gerçek bakım sağlıyoruz.            </p>
          </motion.div>
